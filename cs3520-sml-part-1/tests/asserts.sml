...
fun roundint a = Real.round (a*1000000.0)
val assert_equals_real          = mk_assert_formatted (fn (e,a) => roundint e = roundint a) real_formatter
val assert_equals_real_list     = mk_assert_formatted (fn (e,a) => map roundint e = map roundint a) real_list_formatter
